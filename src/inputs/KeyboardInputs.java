...
public class KeyboardInputs implements KeyListener {
        ...
        public void run() {
            try {
                if (gamePanel.getGame() == null || gamePanel.getGame().getPlayer1() == null
                        || gamePanel.getGame().getPlayer2() == null) {
                    return;
                }
    ...
    private boolean collisionwithdeath1() {
        try {
            if (gamePanel.getGame() == null || gamePanel.getGame().getdeath() == null
                    || gamePanel.getGame().getPlayer1() == null) {
                return false;
            }
    ...
    private void checkBeheadedKnockback(boolean attackHit) {
        try {
            if (!attackHit || gamePanel.getGame() == null || gamePanel.getGame().getPlayer1() == null
                    || gamePanel.getGame().getPlayer2() == null) {
                return;
            }

            // Check if player1 is beheaded and C skill is ready
            int charId = playerz.CharacterPick.getChosen();
            ...
            int charId2 = playerz.CharacterPick.getPicked();
                                    ...
                                    damageTimer.schedule(new TimerTask() {
                                        ...
                                        public void run() {
                                            try {
                                                ...
                                                Rectangle2D.Float attackBox1 = gamePanel.getGame()
                                                        .getPlayer1().attackBox1;
                                                Rectangle2D.Float hitbox2 = gamePanel.getGame().getPlayer2()
                                                        .getHitbox();

                                                if (attackBox1 != null && hitbox2 != null
                                                        && attackBox1.intersects(hitbox2)) {
                                    ...
                                    damageTimer.schedule(new TimerTask() {
                                        ...
                                        public void run() {
                                            try {
                                                ...
                                                // Check collision manually and deal damage
                                                Rectangle2D.Float attackBox2 = gamePanel.getGame()
                                                        .getPlayer2().attackBox2;
                                                Rectangle2D.Float hitbox1 = gamePanel.getGame().getPlayer1()
                                                        .getHitbox();

                                                if (attackBox2 != null && hitbox1 != null
                                                        && attackBox2.intersects(hitbox1)) {
                                                    // Deal damage directly - 3500 for teleport skill
                                                    int damage = 3500;
